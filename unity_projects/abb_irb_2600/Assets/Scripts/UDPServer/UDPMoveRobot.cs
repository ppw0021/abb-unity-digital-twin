...
public class UDPMoveRobot : MonoBehaviour
{
    ...
    public void SetLinkRotation(IRB2600 robotJoints)
    {
        link1_rotation = (float)robotJoints.joint_1;
        link2_rotation = (float)robotJoints.joint_2;
        link3_rotation = (float)robotJoints.joint_3;
        link4_rotation = (float)robotJoints.joint_4;
        link5_rotation = (float)robotJoints.joint_5;
        link6_rotation = (float)robotJoints.joint_6;
    }
